...
JOBS = [
    ...
    },
    {
        ...
        "description": "Si alguna vez has deseado trabajar con startups de la mismísima California, Celtiberian es la oportunidad que estabas buscando. Somos una consultora de software comprometida con brindar servicios de calidad y formar a nuestro equipo con el conocimiento más puntero disponible.",
    ...
    },
    {
        ...
        "description": "Si alguna vez has deseado trabajar con startups de la mismísima California, Celtiberian es la oportunidad que estabas buscando. Somos una consultora de software comprometida con brindar servicios de calidad y formar a nuestro equipo con el conocimiento más puntero disponible.",
        "location": "Granada / Remoto",
        "skills": ["Kubernetes", "Docker", "Python", "JavaScript",],
